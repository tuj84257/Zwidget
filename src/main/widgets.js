...
const batteryLevelWidget = new Widget('Battery Level', 160, 150, './widgets-backend/batteryLevel.js', path.join(__dirname, '../preload/batteryLevel.js'), './src/renderer/templates/batteryLevel.html');
